...
'''
Author: Kun
Date: 2022-01-24 20:05:29
LastEditTime: 2022-01-24 20:05:29
LastEditors: Kun
Description: 
FilePath: /projects/my_open_projects/GANs-implementation/image_transfer/stargan/datasets.py
'''
...
class CelebADataset(Dataset):
    def __init__(self, root, transforms_=None, mode="train", attributes=None):
        ...
        self.files = self.files[:-
                                2000] if mode == "train" else self.files[-2000:]
